...
taba = xtabs(nhhmem ~ WS8 , hh) %>% 
  rbind(xtabs(nhhmem ~ as_factor(HH6) + sufficentwater + nmemnotsufficent , hh)) %>% 
  rbind(xtabs(nhhmem ~ as_factor(HH7) + sufficentwater  + nmemnotsufficent  , hh)) %>% 
  rbind(xtabs(nhhmem ~ as_factor(helevel) + sufficentwater  + nmemnotsufficent , hh)) %>% 
  rbind(xtabs(nhhmem ~ drinkingWater + sufficentwater + nmemnotsufficent , hh)) %>% 
  rbind(xtabs(nhhmem ~ as_factor(windex5) + sufficentwater + nmemnotsufficent , hh)) 
...
colnames(taba) = c(levels(as_factor(hh$sufficentwater))[c(1:3,5)], "Total", label(hh$nhhmem))
